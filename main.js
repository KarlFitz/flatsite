...
$(document).ready(function() {
  ...
  $('.hero').videoBG({
    mp4:'assets/small_loop_black.mp4',
    ogv:'assets/small_loop_black.ogv',
    webm:'assets/small_loop_black.webm',
    poster:'assets/eventarmy.jpg',
    scale:true,
    zIndex:0
  });
...
/*! Launch Mobile Navigation Menu */
/*! -------------------------------------------------------------------------------- */

$(function() {

  $("nav#menu").clone().attr('id', '' ).addClass("menu-bar menu-horizontal").insertBefore("nav#menu");
  $("nav#menu").mmenu({
    // options:
    position            : 'left',
    header              : true,
...
/*! Input placeholders for IE9 and below */
/*! -------------------------------------------------------------------------------- */
